...
class Section implements IHasChildren
{
    ...
    public static function make(array $children): static
    {
        ...
        $container->setView('laraform::components.section');
        $container->setHtmlAttribute('class', 'content rounded uk-background-default');
